...
const ExpenseForm: React.FC<ExpenseFormProps> = ({ onSubmit }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className=" mt-4 mb-4 w-5/6 mx-auto">
      <h2 className="text-xl font-bold text-center mb-2 text-blue-500">Expense Form</h2>
      <div className="flex flex-col space-y-4">
        ...
        <button type='button' className="bg-yellow-500 text-white py-2 px-4 rounded-lg hover:bg-yellow-600 w-1/4 mx-auto" onClick={handleClearClick}>CLEAR</button>
        <button type="submit" className="bg-blue-500 text-white py-2 px-4 rounded-lg hover:bg-blue-600 w-1/3 mx-auto">ADD EXPENSE</button>
        </div>
        {selectedField === 'tag' && (
          <div>
